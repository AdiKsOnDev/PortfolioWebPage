...
function Project(props) {
    return ( 
        <div className="flex flex-col w-fit mx-12 justify-center items-start p-6 mt-10 rounded-2xl bg-secondary">
            ...
            <a href={props.gitRepo} className="flex flex-row justify-center items-center text-tertiary py-1 px-3 bg-primary font-semibold rounded-lg mt-4 hover:bg-accent duration-300 hover:text-primary " target="_blank" rel="noopener noreferrer">
